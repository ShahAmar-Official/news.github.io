"""Central configuration for the News Shorts Automation pipeline."""

import os

# API Keys (loaded from GitHub Secrets / environment variables)
# NOTE: No paid API keys required for TTS and script generation!
# TTS uses Microsoft's free edge-tts neural voices.
...
NEWSAPI_KEY: str = os.getenv("NEWSAPI_KEY", "")  # NewsAPI.org key — required for this news channel
...
# ---------------------------------------------------------------------------
TTS_VOICE: str = "en-US-GuyNeural"    # fallback voice if rotation is disabled (newscast style)
