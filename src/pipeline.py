"""
pipeline.py — Main orchestrator for the News Shorts automation pipeline.

Runs all steps in sequence:
  1. Fetch the top breaking news story
...
def run_pipeline() -> None:
    """Execute the full News Shorts creation and upload pipeline."""
    start_time = time.time()
    logger.info("=" * 60)
    logger.info("News Shorts Automation — pipeline starting")
    logger.info("=" * 60)
    ...
    try:
        ...
        # ------------------------------------------------------------------
        # Step 1: Find top breaking news story
        # ------------------------------------------------------------------
        logger.info("[1/6] Fetching top news stories…")
        from src.news_sources import get_top_news_story  # noqa: PLC0415

        topic = get_top_news_story()
        logger.info("      News story selected: '%s'", topic)

        # ------------------------------------------------------------------
        # Step 2: Generate AI script
        # ------------------------------------------------------------------
        logger.info("[2/6] Generating news script for story: '%s'…", topic)
        ...
        logger.info("=" * 60)
        logger.info("News Shorts pipeline completed in %.1f seconds", elapsed)
        logger.info("  Story      : %s", topic)
        logger.info("  Title      : %s", title)
